...
export interface TrialNodeWidgetProps {
  node: TrialNodeModel;
...
export class TrialNodeWidget extends React.Component<TrialNodeWidgetProps> {
  render() {
    return (
      <div
        className={'trial-node'}
        style={{
          position: 'relative',
          width: SIZE,
          height: SIZE,
          boxSizing: "border-box",
          border: `${BORDER_WIDTH}px solid ${this.props.color ?? "rgb(17, 85, 204)"}`,
      ...
      >
        ...
        <PortWidget
          style={{
            left: SIZE / 2 - BORDER_WIDTH - PORT_SIZE / 2,
            top: SIZE - BORDER_WIDTH - PORT_SIZE / 2,
            position: 'absolute'
          }}
