...
- [Basic](#basic)
    ...
    - [6. 输出层的设计](#6-输出层的设计)
        ...
        - [6.2 防止 softmax 函数溢出](#62-防止-softmax-函数溢出)
        - [6.3 softmax 函数的特征](#63-softmax-函数的特征)
            - [6.3.1 反映概率](#631-反映概率)
            - [6.3.2 可以省略 softmax 函数](#632-可以省略-softmax-函数)
        - [6.4 输出层的神经元数量](#64-输出层的神经元数量)
