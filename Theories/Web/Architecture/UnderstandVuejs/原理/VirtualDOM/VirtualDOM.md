...
- [Virtual DOM](#virtual-dom)
    ...
    - [Virtual DOM 的优点](#virtual-dom-的优点)
        ...
        - [避免不必要的 DOM 更新——diff 算法](#避免不必要的-dom-更新diff-算法)
        - [扩展使用](#扩展使用)
