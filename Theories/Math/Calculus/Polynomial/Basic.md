...
2. 但如果分别考虑分子分母，其他各自的极限都是   正无穷，但这两种正无穷是有差别。
...
1. 本质上，你还是要知道，当 x → ∞ 时，影响算式值的是哪一部分。
    <img src="./images/06.png" width="200" style="display: block;" />
...
4. 再这个有些特殊的情况
    <img src="./images/08.png" width="200" style=" display: block;" />
5. 可以看出来分母是趋向于正无穷，分子两部分相减会趋向于负无穷，结果是负数。
6. 分子的首项是 2x^3，但是如果除以再乘以这个首项，会是如下的计算结果
    <img src="./images/09.jpg" width="600" style="display: block;" />
    前半部分趋向于0，后半部分趋向于正无穷，两者乘积的极限是没法确定的。
7. 使用共轭表达式解决分子的困境
    <img src="./images/10.jpg" width="600" style="display: block;" />
